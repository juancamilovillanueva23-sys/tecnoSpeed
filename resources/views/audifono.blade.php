    ...
    <div class="flex flex-col md:flex-row gap-8 mt-4 p-4">
        <div>
            <aside class="w-full md:w-64 bg-white p-5 rounded-[32px] border-[4px] border-blue-700 h-auto">
                ...
                <p class="mt-4 text-black font-bold">Audífonos inalámbricos</p>
                <p class="mt-4 text-black font-bold">Audífonos de cable</p>
                <p class="mt-4 text-black font-bold">Audífonos diadema</p>
